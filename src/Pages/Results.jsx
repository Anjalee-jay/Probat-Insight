...
export default function Results() {
  ...
  const overallScore = Math.round(BATTING_POSITIONS.reduce((a, b) => a + b.score, 0) / BATTING_POSITIONS.length);
      ...
      <div className={`rs-root${mounted ? " mounted" : ""}`}>
        ...
        <div className="rs-hero">
          <div className="rs-score-card">
            <div>
              <div className="rs-score-label">Overall Score</div>
              <div className="rs-score-sub">BATTING TECHNIQUE</div>
            </div>
            <RadialScore score={overallScore} color="#42FF4E" size={110} />
